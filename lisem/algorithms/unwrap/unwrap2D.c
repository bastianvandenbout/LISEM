...
static inline void  initialisePIXELs(float *wrapped_image, unsigned char *input_mask, unsigned char *extended_mask, PIXELM *pixel, int image_width, int image_height)
{
...
static inline int find_wrap(float pixelL_value, float pixelR_value)
{
  float difference;
  int wrap_value;
...
static inline void extend_mask(unsigned char *input_mask, unsigned char *extended_mask,
...
static inline void calculate_reliability(float *wrappedImage, PIXELM *pixel,
			   int image_width, int image_height,
			   params_t *params)
{
  int image_width_plus_one = image_width + 1;
...
//unwrap the image
static inline void  unwrapImage(PIXELM *pixel, int image_width, int image_height)
{
  int i;
...
static inline void  maskImage(PIXELM *pixel, unsigned char *input_mask, int image_width, int image_height)
{
...
//phase map.
static inline void  returnImage(PIXELM *pixel, float *unwrapped_image, int image_width, int image_height)
{
  int i;
  int image_size = image_width * image_height;
