...
static inline void  initialiseVOXELs(float *WrappedVolume, unsigned char *input_mask, unsigned char *extended_mask, VOXELM *voxel, int volume_width, int volume_height, int volume_depth)
{
...
static inline float wrap(float voxel_value)
{
...
static inline int find_wrap(float voxelL_value, float voxelR_value)
{
  float difference;
  int wrap_value;
...
static inline void extend_mask(unsigned char *input_mask, unsigned char *extended_mask, int volume_width, int volume_height, int volume_depth, params_t *params)
{
  int n, i, j;
  int vw = volume_width;
...
static inline void calculate_reliability(float *wrappedVolume, VOXELM *voxel, int volume_width, int volume_height, int volume_depth, params_t *params)
{
  int frame_size  = volume_width * volume_height;
...
//unwrap the volume
static inline void unwrapVolume(VOXELM *voxel, int volume_width, int volume_height, int volume_depth)
{
  int i;
  int volume_size = volume_width * volume_height * volume_depth;
  VOXELM *voxel_pointer=voxel;
...
//phase map.
static inline void  returnVolume(VOXELM *voxel, float *unwrappedVolume, int volume_width, int volume_height, int volume_depth)
{
  int i;
  int volume_size = volume_width * volume_height * volume_depth;
