...
namespace gs
{
	...
	*/
	...
	@return Mat*
	*/
    LISEM_API  cv::Mat* superResolve(cv::Mat inputImage, float upscale, int iterations, double lambda, unsigned int patchSize, unsigned int patchOverlap, unsigned int neighborhoodSize, double neighborhoodWeight);
	...
	@return Mat*
	*/
    LISEM_API  cv::Mat* superResolveWavelet(cv::Mat inputImage, float upscale, int iterations, double lambda, int patchSize, unsigned int patchOverlap, unsigned int neighborhoodSize, double neighborhoodWeight, int waveletP, int waveletQ);
