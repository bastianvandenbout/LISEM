...
#include <sfm/wrap/dae/xmldocumentmanaging.h>
...
template<> struct CoordNumber<sfm/vcg::Point2f> { public:	static unsigned int coord() { return 2;	} };
template<> struct CoordNumber<sfm/vcg::Point3f> { public:	static unsigned int coord() {	return 3;	} };
template<> struct CoordNumber<sfm/vcg::Point4f> { public: static unsigned int coord() {	return 4;	} };

template<> struct CoordNumber<sfm/vcg::Color4b> { public:	static unsigned int coord() { return 4;	} };
