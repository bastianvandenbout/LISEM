...
public:
  ...
  void AddPerVertexPoint3fAttribute(MeshType &m, const char *attrName, const char *propName="")
  {
    ...
    typename MeshType::template PerVertexAttributeHandle <sfm/vcg::Point3f> 
        ht = vcg::tri::Allocator<MeshType>:: template GetPerVertexAttribute <sfm/vcg::Point3f> (m,attrName);
