...
#include <sfm/wrap/io_trimesh/io_mask.h>
#include <sfm/wrap/io_trimesh/io_material.h>
#include <sfm/wrap/io_trimesh/io_fan_tessellator.h>
#ifdef __gl_h_
#include <sfm/wrap/gl/glu_tesselator.h>
#endif
      ...
      if (numTokens > 0)
      {
        ...
        else if( (header.compare("f")==0) || (header.compare("q")==0) )  // face
        {
          ...
          else
          {
            ...
            std::vector<std::vector<sfm/vcg::Point3f> > polygonVect(1); // it is a vector of polygon loops
            ...
            else
            {
              ...
              vcg::glu_tesselator::tesselate<sfm/vcg::Point3f>(polygonVect, indexTriangulatedVect);
