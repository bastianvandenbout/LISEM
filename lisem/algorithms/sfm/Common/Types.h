...
inline bool   ISZERO(float  x)				{ return (x < 0.0f? -x :  x) < FZERO_TOLERANCE; }
inline bool   ISZERO(double x)				{ return (x < 0.0f? -x :  x) < ZERO_TOLERANCE; }

inline bool   ISEQUAL(float  x, float  v)	{ return ((x-v) < 0.0f? -(x-v) :  (x-v)) < FZERO_TOLERANCE; }
inline bool   ISEQUAL(double x, double v)	{ return ((x-v) < 0.0f? -(x-v) :  (x-v)) < ZERO_TOLERANCE; }
