...
#include <sfm/vcg/math/matrix33.h>
...
void RotationalPartByPolarDecomposition( const vcg::Matrix33<S> & m, vcg::Matrix33<S> &r ){
	...
	bool ss = SingularValueDecomposition<sfm/vcg::Matrix33<S> >(tmp,&e[0],res);
	...
	bool s1 = SingularValueDecomposition<sfm/vcg::Matrix33<S> >(tmp,&e[0],res.transpose());
	e[0]=1/e[0];
	e[1]=1/e[1];
	e[2]=1/e[2];
