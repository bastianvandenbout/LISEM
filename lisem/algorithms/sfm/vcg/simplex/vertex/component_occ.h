...
template <class T> class Coord3fOcc: public CoordOcc<sfm/vcg::Point3f, T> {};
template <class T> class Coord3dOcc: public CoordOcc<sfm/vcg::Point3d, T> {};
...
template <class T> class Normal3sOcc: public NormalOcc<sfm/vcg::Point3s, T> {};
template <class T> class Normal3fOcc: public NormalOcc<sfm/vcg::Point3f, T> {};
template <class T> class Normal3dOcc: public NormalOcc<sfm/vcg::Point3d, T> {};
...
template <class T> class Color4bOcc: public ColorOcc<sfm/vcg::Color4b, T> {};
