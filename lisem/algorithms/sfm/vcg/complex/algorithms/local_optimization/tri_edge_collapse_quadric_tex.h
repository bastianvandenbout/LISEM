...
#include <sfm/vcg/math/quadric5.h>
namespace vcg
{
namespace tri
{
...
class QuadricTexHelper
  ...
  typedef	SimpleTempData<typename MeshType::VertContainer, std::vector<std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> > > > Quadric5Temp;
  typedef	SimpleTempData<typename MeshType::VertContainer, math::Quadric<double> > QuadricTemp;
    ...
    {
       std::vector<std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> > > &qv = Vd(v);
       ...
       qv.push_back(std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> >(newcoord,newq5));
    }
    ...
    static std::vector<std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> > > &Vd(VertexType *v){return (TD()[*v]);}
...
// puntatori ai vertici che sono stati messi non-w per preservare il boundary
  ...
  std::vector<std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> > > qv;
  int ncoords;
  VertexType * v[2];
  v[0] = this->pos.V(0);
  v[1] = this->pos.V(1);
  ...
  qv.push_back(std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> >(newtcoord,newq));
  ...
  if(ncoords > 1)
  {
    ...
    qv.push_back(std::pair<sfm/vcg::TexCoord2f ,Quadric5<double> >(newtcoord2,newq));
  }
