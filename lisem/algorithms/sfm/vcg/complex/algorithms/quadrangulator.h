...
#include <sfm/vcg/simplex/face/jumping_pos.h>
...
//               if (p0>p1)continue; //only one verse of coherence
    ...
    struct SplitMidPoint : public   std::unary_function<sfm/vcg::face::Pos<typename MESH_TYPE::FaceType> ,  typename MESH_TYPE::CoordType >
    {
