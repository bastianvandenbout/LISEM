...
#include <sfm/vcg/complex/algorithms/crease_cut.h>
//#include <sfm/vcg/complex/algorithms/curve_on_manifold.h>
...
class VoroEdgeMeshAux
{
	class EmEdgeType;
	class EmVertexType;
	class EUsedTypes : public vcg::UsedTypes<sfm/vcg::Use<EmVertexType>::AsVertexType,
