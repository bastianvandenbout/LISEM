...
#include <sfm/vcg/complex/algorithms/update/curvature.h>
#include <sfm/wrap/io_trimesh/export.h>
...
vcg::Point2<ScalarType> InterpolateNRosy2D(const std::vector<sfm/vcg::Point2<ScalarType> > &V,
                                           ...
                                           const int N)
{
    ...
    std::vector<sfm/vcg::Point2<ScalarType> > VV(V.size(), vcg::Point2<ScalarType>(0,0));
...
template < typename ScalarType >
vcg::Point3<ScalarType> InterpolateNRosy3D(const std::vector<sfm/vcg::Point3<ScalarType> > &V,
                                           const std::vector<sfm/vcg::Point3<ScalarType> > &Norm,
                                           const std::vector<ScalarType>  &W,
                                           const int N,
                                           const vcg::Point3<ScalarType> &TargetN)
{
    ...
    std::vector<sfm/vcg::Point2<ScalarType> > Cross2D;
...
private:
    ...
    static void SubdivideTris(vcg::Triangle3<ScalarType> T3,
                              size_t Nvert,
                              std::vector<sfm/vcg::Triangle3<ScalarType> > &SubTris,
                              int Nsub)
    {
                                             ...
                                             std::vector<CoordType> &NormSubF)
    {
        ...
        {
            std::vector<sfm/vcg::Point3<ScalarType> > TangVect;
            std::vector<sfm/vcg::Point3<ScalarType> > Norms;
