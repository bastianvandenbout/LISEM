...
#include <sfm/wrap/io_trimesh/export_obj.h>

//define a temporary triangle mesh type
class TempFace;
class TempVertex;

struct TempUsedTypes: public vcg::UsedTypes<sfm/vcg::Use<TempVertex>::AsVertexType,
...
public:
    ...
    */
                                   ...
                                   bool FixB=true)
    {
        ...
        std::vector<std::vector<sfm/vcg::Line3<ScalarType> > > SharpEdge(poly_m.vert.size());
