...
#include <ctime>
#include <stdio.h>
#include <sfm/vcg/math/histogram.h>
#include <sfm/vcg/math/matrix44.h>
#include <sfm/vcg/math/random_generator.h>
#include <sfm/vcg/math/gen_normal.h>

#include <sfm/vcg/space/point_matching.h>
#include <sfm/vcg/space/index/grid_static_ptr.h>

#include <sfm/vcg/simplex/face/component_ep.h>

#include <sfm/vcg/complex/complex.h>
#include <sfm/vcg/complex/algorithms/clean.h>
#include <sfm/vcg/complex/algorithms/closest.h>
#include <sfm/vcg/complex/algorithms/update/normal.h>
#include <sfm/vcg/complex/algorithms/update/bounding.h>
#include <sfm/vcg/complex/algorithms/update/component_ep.h>
#include <sfm/vcg/complex/algorithms/update/position.h>
#include <sfm/vcg/complex/algorithms/update/flag.h>
#include <sfm/vcg/complex/algorithms/update/normal.h>
#include <sfm/vcg/complex/algorithms/update/bounding.h>
#include <sfm/vcg/complex/algorithms/point_matching_scale.h>
				...
				if (beyondCntVec[i] < maxBeyondCnt) {
					if (fixbox.IsIn(movvert[i])) {
						...
						if (u.Empty()) {  // using the point cloud grid 
							...
							A2Mesh::FacePointer f = vcg::tri::GetClosestFaceBase<sfm/vcg::AlignPair::A2Mesh, vcg::AlignPair::A2Grid >(*fix, u, movvert[i], maxd, error, closestPoint);
							if (error >= startMinDist) {
								ii.DistanceDiscarded++; ++beyondCntVec[i]; continue;
							}
