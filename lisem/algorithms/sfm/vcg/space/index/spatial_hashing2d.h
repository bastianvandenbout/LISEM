...
#include <sfm/vcg/space/index/grid_util2d.h>
#include <sfm/vcg/space/index/grid_closest2d.h>
//#include <map>
#include <vector>
#include <algorithm>
#ifdef _WIN32
...
namespace vcg{
    ...
    */
    ...
    protected:
        ...
        {
            std::vector<sfm/vcg::Point2i> Indexes;
            ...
            std::vector<sfm/vcg::Point2i>::iterator it=std::unique(Indexes.begin(),Indexes.end());
