...
void QgsCollapsibleGroupBoxBasic::init()
{
  ...
  // init icons
  mCollapseIcon = *(GetResourceManager()->GetIcon(GetResourceManager()->GetDefaultIconName(LISEM_ICON_BOXEXTEND),-1));
  mExpandIcon =*(GetResourceManager()->GetIcon(GetResourceManager()->GetDefaultIconName(LISEM_ICON_BOXCOLLAPSE),-1));
