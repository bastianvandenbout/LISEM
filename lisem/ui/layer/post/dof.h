...
class UIPostDOFLayer : public UILayer
{
private:
...
public:
    ...
    inline UIPostDOFLayer() : UILayer("DOF", false,"",false)
    {
         m_IsNative = false;
         m_IsUser = true;
    ...
    {
        m_Program = m->GetMGLProgram(KernelDir + "PostProcess.vert", KernelDir + "PostDOF.frag");
