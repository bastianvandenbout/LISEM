...
class UIPostLightingLayer : public UILayer
{
private:
...
public:
    ...
    inline UIPostLightingLayer() : UILayer("Lighting", false,"",false)
    {
    ...
    {
        m_Program = m->GetMGLProgram(KernelDir + "PostProcess.vert", KernelDir + "PostLighting.frag");
