...
public:
    ...
    inline void InitParameters()
    {
        ...
        AddParameter(2, LISEM_PARAMETER_MAP,   "Gravel",                 QList<QString>({QString("Gravel content")}),         "Gravel content (volumetric cubic meter per cubic meter)",                                           "gravel.map",               0.001f,   999.00f,  1.0,true , [](ParameterManager*p){return p->GetParameterValueBool("Include Hydrology");} );
        AddParameter(2, LISEM_PARAMETER_MAP,   "Organic",                QList<QString>({QString("Organic Matter")}),         "Organic Matter (kg per square meter)",                                           "om.map",                  0.001f,   999.00f,  1.0,true , [](ParameterManager*p){return p->GetParameterValueBool("Include Hydrology");} );
