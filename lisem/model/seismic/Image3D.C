...
int SeisImage3D::mPreceedZeros = 0;

SeisImage3D* SeisImage3D::nil=static_cast<SeisImage3D*>(0);

//-----------------------------------------------------------------------
SeisImage3D::SeisImage3D( EW* a_ew,
		  double time, 
		  double timeInterval, 
		  int cycle, 
		  int cycleInterval,
...
//-----------------------------------------------------------------------
void SeisImage3D::setSteps(int a_steps)
{
  char buffer[50];
...
//-----------------------------------------------------------------------
bool SeisImage3D::timeToWrite( double time, int cycle, double dt )
{
   // -----------------------------------------------
...
//-----------------------------------------------------------------------
void SeisImage3D::compute_file_suffix( int cycle, std::stringstream& fileSuffix )
{
...
//-----------------------------------------------------------------------
void SeisImage3D::write_image( int cycle, std::string &path, double t,
			   Sarray& a_Z )
{
  //File format: 
  //
