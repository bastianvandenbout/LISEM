...
void EW::processPrefilter(char* buffer)
{
   ...
   SeisFilterType passband = bandPass; // 
...
void EW::processImage3D( char* buffer )
{
   ...
   SeisImage3D::Image3DMode mode=SeisImage3D::RHO;
   ...
   while (token != NULL)
   {
	 ...
	 filePrefix = token;
      ...
      {
	 token += 5; // skip mode=
	 if (strcmp(token, "ux") == 0)        mode = SeisImage3D::UX;
	 else if (strcmp(token, "uy") == 0)   mode = SeisImage3D::UY;
	 else if (strcmp(token, "uz") == 0)   mode = SeisImage3D::UZ;
	 else if (strcmp(token, "rho") == 0)   mode = SeisImage3D::RHO;
	 else if (strcmp(token, "p") == 0)   mode = SeisImage3D::P;
	 else if (strcmp(token, "s") == 0)   mode = SeisImage3D::S;
	 else if (strcmp(token, "mu") == 0)   mode = SeisImage3D::MU;
	 else if (strcmp(token, "lambda") == 0)   mode = SeisImage3D::LAMBDA;
	 else if (strcmp(token, "gradrho") == 0)   mode = SeisImage3D::GRADRHO;
	 else if (strcmp(token, "gradp") == 0)   mode = SeisImage3D::GRADP;
	 else if (strcmp(token, "grads") == 0)   mode = SeisImage3D::GRADS;
	 else if (strcmp(token, "gradmu") == 0)   mode = SeisImage3D::GRADMU;
	 else if (strcmp(token, "gradlambda") == 0)   mode = SeisImage3D::GRADLAMBDA;
	 else if (strcmp(token, "qs") == 0)   mode = SeisImage3D::QS;
	 else if (strcmp(token, "qp") == 0)   mode = SeisImage3D::QP;
	 else
	 {
   ...
   bool forwardgrad = !m_inverse_problem && (mode == SeisImage3D::GRADRHO ||mode == SeisImage3D::GRADMU ||mode == SeisImage3D::GRADLAMBDA ||
					     mode == SeisImage3D::GRADP   ||mode == SeisImage3D::GRADS);
   ...
   bool attenuation = (mode == SeisImage3D::QS || mode == SeisImage3D::QP );
   ...
   if( !forwardgrad )
   {
      ...
      SeisImage3D* im3 = new SeisImage3D( this, time, timeInterval, cycle, cycleInterval, 
...
//   int pfs = 0, nwriters=1;
   SeisImage::ImageMode mode=SeisImage::RHO;
   double time=0.0, timeInterval=0.0;
   bool timingSet = false;
   ...
   // -----------------------------------------------------
  SeisImage::ImageOrientation locationType=SeisImage::UNDEFINED;
  double coordValue;
  int gridPointValue;
  ...
  while (token != NULL)
  {
    ...
    {
      token += 5; // skip mode=
      if (strcmp(token, "ux") == 0)        mode = SeisImage::UX;
      else if (strcmp(token, "uy") == 0)   mode = SeisImage::UY;
      else if (strcmp(token, "uz") == 0)   mode = SeisImage::UZ;
      else if (strcmp(token, "rho") == 0)   mode = SeisImage::RHO;
      else if (strcmp(token, "lambda") == 0)   mode = SeisImage::LAMBDA;
      else if (strcmp(token, "mu") == 0)   mode = SeisImage::MU;
      else if (strcmp(token, "uxexact") == 0)   mode = SeisImage::UXEXACT;
      else if (strcmp(token, "uyexact") == 0)   mode = SeisImage::UYEXACT;
      else if (strcmp(token, "uzexact") == 0)   mode = SeisImage::UZEXACT;
      else if (strcmp(token, "p") == 0)   mode = SeisImage::P;
      else if (strcmp(token, "s") == 0)   mode = SeisImage::S;
      else if (strcmp(token, "div") == 0)   mode = SeisImage::DIV;
      else if (strcmp(token, "curl") == 0)   mode = SeisImage::CURLMAG;
//      else if (strcmp(token, "curlmag") == 0)   mode = Image::CURLMAG; // strange name, remove ??
      else if (strcmp(token, "veldiv") == 0)   mode = SeisImage::DIVDT;
      else if (strcmp(token, "divdudt") == 0)   mode = SeisImage::DIVDT;
      else if (strcmp(token, "velcurl") == 0)   mode = SeisImage::CURLMAGDT;
      else if (strcmp(token, "curldudt") == 0)   mode = SeisImage::CURLMAGDT;
      else if (strcmp(token, "lat") == 0)   mode = SeisImage::LAT;
      else if (strcmp(token, "lon") == 0)   mode = SeisImage::LON;
      else if (strcmp(token, "hvelmax") == 0) mode = SeisImage::HMAXDUDT;
      else if (strcmp(token, "hmaxdudt") == 0) mode = SeisImage::HMAXDUDT;
      else if (strcmp(token, "hmax") == 0) mode = SeisImage::HMAX;
      else if (strcmp(token, "vvelmax") == 0) mode = SeisImage::VMAXDUDT;
      else if (strcmp(token, "vmaxdudt") == 0) mode = SeisImage::VMAXDUDT;
      else if (strcmp(token, "vmax") == 0) mode = SeisImage::VMAX;
      else if (strcmp(token, "topo") == 0) mode = SeisImage::TOPO;
      else if (strcmp(token, "grid") == 0) mode_is_grid=true;
      else if (strcmp(token, "gridx") == 0) mode = SeisImage::GRIDX;
      else if (strcmp(token, "gridy") == 0) mode = SeisImage::GRIDY;
      else if (strcmp(token, "gridz") == 0) mode = SeisImage::GRIDZ;
      else if (strcmp(token, "uxerr") == 0)   mode = SeisImage::UXERR;
      else if (strcmp(token, "uyerr") == 0)   mode = SeisImage::UYERR;
      else if (strcmp(token, "uzerr") == 0)   mode = SeisImage::UZERR;
      // else if (strcmp(token, "fx") == 0)   mode = Image::FX;
      // else if (strcmp(token, "fy") == 0)   mode = Image::FY;
      // else if (strcmp(token, "fz") == 0)   mode = Image::FZ;
      else if (strcmp(token, "velmag") == 0)   mode = SeisImage::MAGDUDT;
      else if (strcmp(token, "magdudt") == 0)   mode = SeisImage::MAGDUDT;
      else if (strcmp(token, "mag") == 0)   mode = SeisImage::MAG;
      else if (strcmp(token, "hvelmag") == 0)   mode = SeisImage::HMAGDUDT;
      else if (strcmp(token, "hmagdudt") == 0)   mode = SeisImage::HMAGDUDT;
      else if (strcmp(token, "hmag") == 0)   mode = SeisImage::HMAG;
      else if (strcmp(token, "gradrho") == 0)   mode = SeisImage::GRADRHO;
      else if (strcmp(token, "gradmu") == 0)   mode = SeisImage::GRADMU;
      else if (strcmp(token, "gradlambda") == 0)   mode = SeisImage::GRADLAMBDA;
      else if (strcmp(token, "gradp") == 0)   mode = SeisImage::GRADP;
      else if (strcmp(token, "grads") == 0)   mode = SeisImage::GRADS;
      else if (strcmp(token, "qp") == 0) mode = SeisImage::QP;
      else if (strcmp(token, "qs") == 0) mode = SeisImage::QS;
  ...
  // }
   ...
   bool forwardgrad = !m_inverse_problem && (mode == SeisImage::GRADRHO ||mode == SeisImage::GRADMU ||mode == SeisImage::GRADLAMBDA ||
					     mode == SeisImage::GRADP   ||mode == SeisImage::GRADS);
   if( forwardgrad && proc_zero() )
   {
  ...
  // Set up the image object
	 ...
	 if( mode_is_grid )
	 {
	    if( locationType == SeisImage::X )
	    {
	       i = new SeisImage(this, time, timeInterval, cycle, cycleInterval, 
			 filePrefix, SeisImage::GRIDY, locationType, coordValue, use_double);
	       addImage(i);
	       i = new SeisImage(this, time, timeInterval, cycle, cycleInterval, 
			 filePrefix, SeisImage::GRIDZ, locationType, coordValue, use_double);
	       addImage(i);
	    }
	    else if( locationType == SeisImage::Y )
	    {
	       i = new SeisImage(this, time, timeInterval, cycle, cycleInterval, 
			 filePrefix, SeisImage::GRIDX, locationType, coordValue, use_double);
	       addImage(i);
	       i = new SeisImage(this, time, timeInterval, cycle, cycleInterval, 
			 filePrefix, SeisImage::GRIDZ, locationType, coordValue, use_double);
	       addImage(i);
	    }
	    else if( locationType == SeisImage::Z )
	    {
	       i = new SeisImage(this, time, timeInterval, cycle, cycleInterval, 
			 filePrefix, SeisImage::GRIDX, locationType, coordValue, use_double);
	       addImage(i);
