...
void associate_gridfiles( std::vector<SeisImage*>& imgs );
...
SeisImage(); // make it impossible to call default constructor
SeisImage(const SeisImage &im); // hide copy constructor 
...
SeisImage* m_gridimage; // Curvilinear grid z-coordinate 
