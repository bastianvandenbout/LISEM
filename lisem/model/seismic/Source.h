...
// keep track of new filtering approach:
   ...
   void prepareTimeFunc(bool doFilter, double sw4TimeStep, int sw4TimeSamples, SeisFilter *sw4_filter);
  ...
  void filter_timefunc( SeisFilter* fi, double tstart, double dt, int nsteps );
