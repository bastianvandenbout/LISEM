...
void StableFluid3d::SetBounds(const int b, float * d, int c= 0)
{
    ...
    for (int y = 0; y < resY; y++)
    {
        for (int x = 0; x < resX; x++)
        {
            for(int z = 0; z < resZ; z++)
            {
                ...
                if(x> 1)
                {
                   in_x1 = _block[IX(z,y,x-1)];
                   val_x1 = d[IX(z,y,x-1)];
                }
                if(x< resX-1)
                {
                   in_x2 = _block[IX(z,y,x+1)];
                   val_x2 = d[IX(z,y,x+1)];
                }
                if(y> 1)
                {
                   in_y1 = _block[IX(z,y-1,x)];
                   val_y1 = d[IX(z,y-1,x)];
                }
                if(y< resY-1)
                {
                   in_y2 = _block[IX(z,y+1,x)];
                   val_y2 = d[IX(z,y+1,x)];
                }

                if(z> 1)
                {
                   in_z1 = _block[IX(z-1,y,x)];
                   val_z1 = d[IX(z-1,y,x)];
                }
                if(z< resZ-1)
                {
                   in_z2 = _block[IX(z+1,y,x)];
                   val_z2 = d[IX(z+1,y,x)];
                }
                ...
                if(in)
                {
                    ...
                    if(c == 0)
                    {
                        ...
                        d[IX(z,y,x)] = std::max({val_x1,val_x2,val_y1,val_y2,val_z1,val_z2});
                    }
                }
