...
inline void init_pylisem_algorithm(py::module &m)
{
    ...
    m.def("DrainageNetwork",py::overload_cast<cTMap*,bool>(&AS_DrainageNetwork),py::arg("Elevation"), py::arg("use4") = false);

    m.def("DrainageNetwork",py::overload_cast<cTMap*, bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("use4")=false);
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,cTMap*,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,cTMap*,cTMap*,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,cTMap*,float,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,float,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,cTMap*,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,cTMap*,cTMap*,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,cTMap*,float,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,float,float,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,float,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,cTMap*,float,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,float,cTMap*,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,cTMap*,float,float,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,float,cTMap*,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,float,float,cTMap*, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetwork",py::overload_cast<cTMap*,float,float,cTMap*,float, bool,bool>(&AS_DrainageNetwork),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));

    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("use4")=false);
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,cTMap*,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,cTMap*,cTMap*,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,cTMap*,float,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,float,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,cTMap*,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,cTMap*,cTMap*,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,cTMap*,float,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,float,float,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,float,cTMap*,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,cTMap*,float,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,float,cTMap*,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,cTMap*,float,float,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,float,cTMap*,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,float,float,cTMap*, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
    m.def("DrainageNetworkDEM",py::overload_cast<cTMap*,float,float,cTMap*,float, bool,bool>(&AS_DrainageNetworkDEM),py::arg("Elevation"),py::arg("Outflowdepth"),py::arg("CoreVolume"),py::arg("CoreArea"),py::arg("Precipitation"), py::arg("lddin") = true,py::arg("use4"));
